...
A Particle project named cerveza-device

## Welcome to your project!

Every new Particle project is composed of 3 important elements that you'll see have been created in your project directory for cerveza-device.
...
- Any libraries stored under `lib/<libraryname>/src`# cerveza-device
